\documentclass[2headlines,a4paper,10pt]{scrreprt}
...
\chead{DrPsychick \(\bullet\) email: drpsychick@drsick.net \(\bullet\) org: sickhub.org }
\cfoot{brought to you by SickHub.org}
